...
function mob_val(inputtxt)
{
  ...
  if((inputtxt.value.match(phoneno))
      ...
      return true;
        ...
        {
        alert("invalid number!enter correct mobile number");
        return false;
        }
}
...
var lang = document.registration.lang; 
if(allLeter(uname))
{
if(pass_validation(pass,7,10))
{
if(mob_val(mno))
{
